...
If you use **dplyr** you're probably familiar with the `group_by()` function. This will generate a grouped tibble, and you can pass that into `gt()`. The package will know what to do with a grouped tibble:
...
Write an HTML file with inlined CSS (which is necessary for including the table as part of an HTML email in the **blastula** package).
